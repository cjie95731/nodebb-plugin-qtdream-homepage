...
<div class="imageitems col-md-3 col-xs-6">
	...
	<div class="imageitem_popularity" style="background-color: "transparent" ><i class="fa fa-play-circle"></i>{imageitems.popularity}</div>
        <a class="imageitem_title" href="{imageitems.titleUrl}">{imageitems.title}</a>
        <div class="hide_on_hover" id="hover_{imageitems.id}" style="background-color: "transparent"></div>
